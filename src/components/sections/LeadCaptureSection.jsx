...
function LeadCaptureSection({ formState, onSubmit }) {
  return (
    <section className="section-shell py-24" id="contact">
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <GlassCard className="p-7 sm:p-8">
          <form className="grid gap-5" onSubmit={onSubmit} noValidate>
            ...
            <label className="grid gap-2 text-sm text-slate-300"><span>Message</span><textarea name="message" required rows="6" className="rounded-3xl border border-white/10 bg-white/6 px-4 py-3 text-white outline-none transition focus:border-cyan-300/40" placeholder="Describe your app idea, dashboard requirement, API issue, bug, or business workflow." /></label>
